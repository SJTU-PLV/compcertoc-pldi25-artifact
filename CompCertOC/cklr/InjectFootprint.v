...
Next Obligation. (* ~> vs. match_stbls *)
  ...
  - destruct H7 as [_ H7]. apply Mem.unchanged_on_support in H7. eauto.
  - destruct H8 as [_ H8]. apply Mem.unchanged_on_support in H8. eauto.
Qed.
...
Next Obligation.
  ...
  destruct Hw'. inv H. inv Hm'. destruct H5, H4.
...
Qed.
  ...
  Proof.
    ...
    destruct (j1 b) as [[ ]|] eqn:j1b; try eauto with mem.
...
*)
  ...
  Proof.
    ...
    - exploit INCRDISJ1; eauto. intros [A B]. rewrite H1 in s.
      inversion INJ12. exploit mi_mappedblocks; eauto. intro. intro.
      subst. apply B. apply H4.
  ...
  Proof.
    ...
    - simpl in H.
      ...
      + unfold Mem.map_block in H.
        ...
        destruct (j1 a) eqn: Hja; try congruence.
        destruct (Mem.sup_dec); try congruence.
  ...
  Proof.
    ...
    assert (b1 = b1').
    { destruct (eq_block b1 b1'). auto.
      exploit INCRNOLAP'1; eauto. intro. inv H6.
    }
  ...
  Proof.
    intros.
    unfold Mem.map_block. rewrite H.
    destruct (j1 b1) eqn:Hj1; try congruence.
    destruct Mem.sup_dec; try congruence.
  ...
  Proof.
    ...
    destruct (j1 b1') eqn: Hj1b1'; eauto.
...
Proof.
  ...
  - intros w13' m1' m3' MMEM13' INCR13'.
    ...
    cbn.
    inversion INCR13' as [? ? ? ? ? ? ? ? ROUNC1 ROUNC3 MAXPERM1 MAXPERM3 [S1 UNCHANGE1] [S3 UNCHANGE3] INCR13 DISJ13]. subst.
...
Proof.
  ...
  - intros [j' ? ? MMEM'] m1' m2' A B. inv A. inv B.
    ...
    + constructor; eauto.
      destruct H9 as [_ H9]. inv H9; eauto.
      destruct H10 as [_ H10]. inv H10; eauto.
Qed.
