...
CONCUR=CallconvBig.v \
       ...
       CAnew.v MultiLibs.v CMulti.v AsmMulti.v ThreadLinking.v ThreadLinkingBack.v\
...
#DEMO= Demo.v Demospec.v # Demoproof.v\
  ...
  # ClientMR.v ClientServerMRCSpec.v ClientServerMRCSpec2.v\
  # ClientServer.v 

CDEMO= Encrypt.v EncryptSpec.v Encryptproof.v \
       Client.v Server.v Demoproof.v 
