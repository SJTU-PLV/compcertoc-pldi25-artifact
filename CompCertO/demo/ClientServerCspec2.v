...
(** Definition of the semantics linking between client.c and L2 (specification of server_opt.s) *)
...
(** top_spec2 ⫹_injp composed_spec2  *)
    ...
    + destruct (peq i 1).
      ...
      ++ destruct (peq i 6).
         ...
         { unfold Genv.globalenv. simpl.
           ...
           1-8: try setoid_rewrite NMap.gsspec.
           1-8: destruct NMap.elt_eq;try congruence.
